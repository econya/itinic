...
ActiveRecord::Schema.define(version: 20160422101610) do
  ...
  add_index "tool_uses", ["community_id"], name: "index_tool_uses_on_community_id"
  add_index "tool_uses", ["technology_id"], name: "index_tool_uses_on_technology_id"
